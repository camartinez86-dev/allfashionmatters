...
const OUTPUT_DIR = '/root/.openclaw/workspace/fyifinds/posts/2026-03-30-monday-fitness-gear-under-50';
...
async function main() {
  console.log('🚀 Starting Monday Fitness Gear Under $50 Slideshow Generation\n');
  ...
  const manifest = {
    date: '2026-03-30',
    theme: 'Fitness Gear Under $50 - Monday Motivation',
    generatedSlides,
  ...
  console.log('2. Add text overlays using add-overlays.js');
