...
const OUTPUT_DIR = '/root/.openclaw/workspace/fyifinds/posts/2026-03-31-tuesday-fitness-trackers';
...
async function main() {
  console.log('🚀 Starting Tuesday Fitness Trackers Slideshow Generation\n');
  ...
  const manifest = {
    date: '2026-03-31',
    theme: 'Best Fitness Trackers 2026',
    generatedSlides,
